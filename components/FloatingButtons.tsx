...
export default function FloatingButtons() {
  ...
  return (
    <div className="floating-btns">
      <a href="https://wa.me/8617751097209" target="_blank" rel="noopener noreferrer" className="float-btn whatsapp" aria-label="WhatsApp">
      ...
      <button className="float-btn wechat" onClick={openWeChatModal} aria-label="WeChat">
        <span className="tooltip">Add on WeChat</span>
        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a href="tel:+8613613183888" className="float-btn phone" aria-label="Call Us">
      ...
      <button
        className={`float-btn top ${showTop ? 'show' : ''}`}
